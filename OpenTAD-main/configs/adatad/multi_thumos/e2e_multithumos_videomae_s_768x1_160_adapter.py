...
model = dict(
    backbone=dict(
        ...
        custom=dict(
            pretrain="/weights/vit-large-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-229dbb03.pth",
...
load_from = "weights/e2e_multithumos_actionformer_videomae_l_768x1_160_adapter_epoch_79_5d1092c6.pth"
work_dir = "exps/multithumos/adatad/e2e_actionformer_videomae_l_768x1_160_adapter_aug"
